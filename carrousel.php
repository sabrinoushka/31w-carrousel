 ...
 * Description: carrousel d'images cree a partir d'une galerie
 * Author: Olena
...
function carrousel_31w_enqueue(){
    ...
    $version_js = filemtime(plugin_dir_path(__FILE__) . "script/carrousel.js"); // = short_2.php dans ce cas
